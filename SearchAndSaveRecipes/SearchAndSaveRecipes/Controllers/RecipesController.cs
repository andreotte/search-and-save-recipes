...
namespace SearchAndSaveRecipes.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,RecipeURL,Ingredients,ImageURL")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,RecipeURL,Ingredients,ImageURL")] Recipe recipe)
        {
            if (ModelState.IsValid)
            {
